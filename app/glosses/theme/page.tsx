        ...
        <div className="flex gap-4 p-8">
            ...
            <div className="h-fit min-h-screen bg-white rounded-md p-8 border-gold border overflow-auto flex gap-4">
                ...
                <div className="w-[25%] bg-gray-100 p-4 rounded-md">
                    ...
                    <p className="py-2">The same theme or topic could be addressed in various glosses on different authoritative texts. Here you can browse collections of glosses that have been curated around specific research themes.</p>
                    <select className="mb-2 border-2 border-gray-200 rounded-sm w-full p-2 px-3" onChange={(e) => setBook(e.target.value)}>
                        <option value="">Select a Theme</option>
                        {/* Add more options as needed */}
                    </select>
                    <button className="hover:bg-primaryHover shadow-sm bg-primary text-white px-4 rounded-md py-1 items-center gap-1" onClick={handleBrowseClick}>Browse by this Theme</button>
                </div>
            </div> 
        </div>
    )
