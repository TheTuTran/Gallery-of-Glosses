...
const NavbarItem: React.FC<NavbarItemProps> = ({  label, active, href }) => {
	return (
		<Link href={href} className={twMerge('flex flex-row h-auto items-center w-full gap-x-4 text-2xl font-medium cursor-pointer hover:text-white transition text-neutral-400 py-1 hover-underline-animation', active && 'text-white')}>
